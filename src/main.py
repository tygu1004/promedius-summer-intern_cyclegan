...
# train, test
parser.add_argument('--model', dest='model', default='cycle_identity',
                    help='red_cnn, wgan_vgg, cyclegan, cycle_identity')
parser.add_argument('--phase', dest='phase', default='train', help='train, test')

# train detail
parser.add_argument('--epoch', dest='epoch', type=int, default=160, help='epoch')
