...
def discriminator(image_shape, options, reuse=False, name='discriminator'):
    ...
    l1 = first_layer(inputs, options.df_dim, ks=4, s=2, name='disc_layer1')
...
def generator(image_shape, options, reuse=False, name="generator"):
    ...
    inputs = tf.keras.Input(shape=image_shape)
    l1 = conv_layer(inputs, options.gf_dim, name='convlayer1')
